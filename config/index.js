export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx3ffab4b3b6786621",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "5ee7872f77f26b0e33d0f9a11a77268d",
  ...
  USERS: [
    {
      ...
      id: "oVTRn6wibjwnVIqnwyMMxPMiWlRE",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "	sbjSbRNweUOa1PFG0qFvIPgn_Fb_FQv04Rbu7dtVc58",
      // 所在省份
      province: "湖南",
      // 所在城市
      city: "湘潭",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "寰寰", "year": "2004", "date": "08-22"},
        {"type": "节日", "name": "结婚纪念日", "year": "2020", "date": "09-03"},
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {"type": "生日", "name": "寰寰", "year": "2022", "date": "09-17"},
